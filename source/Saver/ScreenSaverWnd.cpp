...
BOOL CScreenSaverWnd::OnEraseBkgnd(CDC* pDC) 
{
	...
	//}
	//else if (m_bAutoClear)
	//{
	//	CRect rcClient;
	//	GetClientRect(&rcClient);
 //       pDC->FillSolidRect(&rcClient, ::GetSysColor(COLOR_BACKGROUND));
	//}
	return TRUE;
}
...
void CScreenSaverWnd::SetAutoClear(BOOL bAutoClear /* = TRUE */)
{
                                    ...
                                    LPARAM lParam)
{
    ...
    try
    {
        retVal = CWnd::WindowProc(uMsg, wParam, lParam);
    }
    catch(...)
    {
    }
                                       ...
                                       LPARAM lParam)
{
    ...
    try
    {
        retVal = ::DefScreenSaverProc(m_hWnd, uMsg, wParam, lParam);
    }
    catch(...)
    {
    }
                               ...
                               WPARAM wParam, LPARAM lParam)
{
    ...
    try
    {
	    ...
	    if (uMsg == WM_DESTROY)
        {
            CScreenSaverWnd::sm_pTheScreenSaver->DestroyWindow();
        }
